...
from lib.stat_parser.learn import build_model
from lib.stat_parser.tokenizer import PennTreebankTokenizer
from lib.stat_parser.treebanks.normalize import un_chomsky_normal_form
from lib.stat_parser.word_classes import is_cap_word
...
class Parser:
    ...
    def norm_parse(self, sentence):
        ...
        words = map(lambda w: w[-1] if type(w) == tuple else w, words)
