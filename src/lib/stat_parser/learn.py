...
from lib.stat_parser.treebanks.parse import normalize_questionbank
from lib.stat_parser.treebanks.normalize import gen_norm
from lib.stat_parser.treebanks.extract import get_sentence
from lib.stat_parser.pcfg import PCFG

from lib.stat_parser.paths import QUESTIONBANK_NORM, QUESTIONBANK_DATA, QUESTIONBANK_PENN_DATA
from lib.stat_parser.paths import PENNTREEBANK_NORM, PENNTREEBANK_GLOB
from lib.stat_parser.paths import TEMP_DIR, MODEL_TREEBANK, MODEL
from lib.stat_parser.paths import TEST_DAT, TEST_KEY
